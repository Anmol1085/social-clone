  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-black text-white">
      <div className="w-full max-w-sm p-8 bg-black border border-gray-800 rounded-lg">
        <h1 className="text-3xl font-bold text-center mb-8 font-serif italic text-white">Instagram</h1>
        ...
        <div className="mt-8 text-center bg-black border border-gray-800 p-4 rounded mt-4">
            <p className="text-sm text-gray-400">
                ...
                <Link to="/register" className="font-semibold text-blue-500">Sign up</Link>
            </p>
        </div>
      </div>
    </div>
